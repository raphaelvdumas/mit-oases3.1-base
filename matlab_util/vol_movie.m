...
wavei(flipud(dba(field(:,j:length(tt):size(field,2)))),[-1000:1000],zz,50-90,110-90);eval(['text(0,100,''' num2str(ttt(j)) ' sec'')']);eval(['a=text(0,50,''' num2str(ttt(j)) ' sec'');']);set(a,'Color',[0 0 0]);drawnow
