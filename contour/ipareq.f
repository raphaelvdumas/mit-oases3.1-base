      SUBROUTINE IPAREQ(SD,NPX,NPY,NPXRD,NPYRD,NXIND,NXKAB,
     & NZX,NZY,Z,FREQ,EXTP,FORM,BUFFER,NRANGE)
      PARAMETER (NLEV1=51)
      CHARACTER*3 XBTYPE, YBTYPE, FORM, EXTP, SDPLOT, RDPLOT
  ...
  360 FORMAT(A40)
  400 FORMAT(F15.4)
  600 FORMAT(1X,' WARNING : ACCEPTABLE VALUES FOR NDIV ARE 1,2 AND 4 ',/,
