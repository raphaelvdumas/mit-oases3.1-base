%[freq_beam]=abel_beamform(fname,chan,ping,z,beams,co,shading,freqs)
%
% Kevin D. LePage
% 5/21/98
% SACLANTCEN
...
function[freq_beam]=abel_beamform(fname,chan,ping,z,beams,co,shading,freqs)
...
steer=(ones(num_b,1)*shading(:)').*exp(-i*freq(k)*2*pi/co*cos(pi/180*beams(:))*z(:)');
